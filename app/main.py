...
def app():
    ...
    # Pestañas: pantalla principal + datos
    tab_main, tab_datos = st.tabs(["💬 Conversación + Ficha", "📊 Datos & Hooks"])

    # ===== TAB PRINCIPAL: Conversación (izq) + Ficha (dcha) =====
    with tab_main:
        ...
        with col_chat:
            ...
            if prompt:
                ...
                # PRIMER mensaje: descripción original
                ...
                # Mensajes posteriores: ir rellenando campos que falten
                else:
                    ...
                    if missing:
                        ...
                        missing = missing_required(st.session_state.slots)
                        if missing:
                            # Preguntar siguiente campo que falte
